...
class HandleNgrokHeaders
{
    ...
    {
        // Ngrok agrega headers especiales que necesitamos procesar
        if ($request->hasHeader('ngrok-skip-browser-warning')) {
            // Ya tiene el header correcto, continuar
        }

        $response = $next($request);

        // Agregar headers CORS adicionales para ngrok
